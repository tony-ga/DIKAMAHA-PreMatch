  ...
  return (
    <>
      ...
      <div className="feature-grid">
        ...
        <FeatureCard href="/markets" eyebrow="APERTURA + CIERRE + LIVE" title="Pronósticos globales" description="Consulta la cinta de mercado publicada por competición y fecha, aislada de los modelos." />
