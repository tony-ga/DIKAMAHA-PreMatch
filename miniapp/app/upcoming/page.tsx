  ...
  return (
    <>
      ...
      <div className="metric-grid compact-metrics">
        <Metric label="Partidos encontrados" value={query.data?.count ?? "—"} accent />
      ...
      {query.isError ? (
        ...
        <StatePanel title={query.isLoading ? "Cargando calendario" : "Sin partidos programados"}>Se consultaron todas las ligas y la ventana futura disponible. Prueba una fecha concreta o vuelve más tarde.</StatePanel>
      )}
    </>
  );
}
