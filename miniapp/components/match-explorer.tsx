          ...
          {fixtures.data.fixtures.map((fixture) => (
            ...
            >
              ...
              <div className="score-row">
                <div className="fixture-teams"><div><EntityImage source={fixture.home_team_logo} label={fixture.home_team_name ?? `Equipo ${fixture.home_team_id}`} size={34} /><strong>{fixture.home_team_name ?? `Equipo ${fixture.home_team_id}`}</strong></div><div><EntityImage source={fixture.away_team_logo} label={fixture.away_team_name ?? `Equipo ${fixture.away_team_id}`} size={34} /><strong>{fixture.away_team_name ?? `Equipo ${fixture.away_team_id}`}</strong></div></div>
