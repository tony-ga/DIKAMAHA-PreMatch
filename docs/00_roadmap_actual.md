...
| 115 | `telegram_mini_app` | desplegada en Railway; acceso privado | BFF Telegram, PostgreSQL y worker Online; menú global activo, alertas en standby; 535 Python + 12 Vitest + 4 Playwright |
...
Mini App y worker ya están desplegados; el menú global del bot está activo. En
paralelo, vigilar drift de la allowlist Hawkes sin reabrir confirmación. No se
exige esperar una cohorte de 500 partidos. Markov, Hawkes y combinado
permanecen en `shadow` hasta una decisión explícita de promoción.
