...
| 115 | `telegram_mini_app` | paridad visual y analítica desplegada; acceso privado | Catálogo 18 ligas/14 días, identidad nominal recuperable, predicción con gráfica 1X2/xG/tabla, live observable y PNG vía BFF; smoke Railway y 543 Python + 16 Vitest + 8 Playwright |
