...
| 115 | `telegram_mini_app` | paridad bot desplegada; acceso privado | Centro de datos y allowlist BFF activos en Railway; 536 Python + 16 Vitest + 7 Playwright; health y cierre auth aprobados |
