...
from src.espn_prospective_connector import EspnFetchResult, EspnRequest
...
def test_poll_is_fresh_raw_first_and_builds_inference_payload() -> None:
    ...
    assert connector.fresh_flags == [False, False, False, False]
    ...
    assert len(snapshot["raw_receipts"]) == 4
